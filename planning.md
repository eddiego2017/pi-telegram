...
- In `topicBinding.native` mode, prompt start/follow-up/failure/empty-prompt replies use `current topic` / `current workspace` wording instead of exposing internal tab names.
