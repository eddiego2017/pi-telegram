...
- In `topicBinding.native` mode, prompt start/follow-up/failure/empty-prompt/abort replies and inactive-completion notices use topic/workspace wording instead of exposing internal tab names.
