...
- `/session` for opening a Telegram-native current-session center with compact stats, latest preview, active-branch history pagination, and per-entry detail views for user, assistant, custom display, and tool-result messages
