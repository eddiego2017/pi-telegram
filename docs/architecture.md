...
- `/session` for opening a Telegram-native current-session center with compact stats, latest preview, and active-branch history pagination rendered as one-line user/assistant/custom rows without tool-call/tool-result noise
